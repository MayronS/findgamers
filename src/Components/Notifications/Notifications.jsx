...
function Notifications() {
  return (
    <div className="flex flex-col p-2 bg-primary/100 absolute z-40 top-0 h-full gap-5">
      <h1 className="text-2xl text-primary/base">Notificações</h1>
      <div className="overflow-y-auto scrollbar scrollbar-thumb-scroll scrollbar-track-slate-100">
        <User
          profilePhoto={user1}
          name="Roberto"
        ...
        <User
          profilePhoto={user2}
          name="Amanda"
          content="Te convidou para um groupo"
        />
        <User
          profilePhoto={user3}
          name="João"
        ...
        <User
          profilePhoto={user5}
          name="Matheus"
          content="Te convidou para uma comunidade"
        />
        <User
          profilePhoto={user6}
          name="Anderson"
